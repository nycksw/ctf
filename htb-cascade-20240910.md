...
A null bind leaks credentials for RCE. An auditing binary leaks more credentials for PE.
...
I want to decompile the binaries I found in the Audit share, so I can decrypt the password found in the `sqlite3` database. I'll use [ILSpy](ilspy-on-kali-20240911.md) to do this.
